<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text ml-1 mt-3"><p>SPK Pemilihan Pengajar Pesantren</p></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../admin/kriteria.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../admin/alternatif.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../admin/penilaian.php">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="../admin/hitung.php">
